...
import os as _os
# Modo headless: si la variable de entorno HEADLESS está a '1', evitamos importar
# librerías gráficas (tkinter, ttkbootstrap, PyQt) para poder ejecutar en servidor.
_HEADLESS = _os.getenv('HEADLESS', '0') == '1'
if not _HEADLESS:
...
# Llamadas a módulos de interfaz: sólo importarlas si no estamos en modo headless
if not _HEADLESS:
    ...
    # Stubs para ejecutar sin GUI
    def mostrar_horario_qt(*args, **kwargs):
        return None
    def main():
        return None
    # Import mínimo de utilidades no-GUI cuando sea posible
    try:
        from Interfaces.Utils_GUI import *
    except Exception:
        pass
